...
# ===========================================================================
HOST = "vineeth"   # shown as  vineeth@github  in the header
...
ROWS = [
    ...
    ("gap",),
    ("sec", "Languages"),
    ("kv", "Core", "Python, C, C++, Java"),
    ("kv", "Web", "HTML, CSS, JavaScript"),
    ("gap",),
    ("sec", "Tools & Platforms"),
    ("kv", "Dev", "VS Code, Git, GitHub, Linux"),
    ("kv", "API", "REST API, Postman"),
    ("kv", "DB", "MySQL, DBMS"),
    ("kv", "Embedded", "Arduino, ESP32, ESP8266"),
    ("kv", "Design", "Photoshop, Figma, Premiere Pro, DaVinci Resolve"),
    ("gap",),
    ("sec", "Concepts"),
    ("bul", "OOPs, DSA, OS, Agile Methodology"),
    ("gap",),
    ("sec", "Soft Skills"),
    ("bul", "Communication, Quick Learner, Enthusiastic"),
]
